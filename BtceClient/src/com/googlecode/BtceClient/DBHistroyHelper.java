...
public class DBHistroyHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ trans_table
				+ "(_id INTEGER PRIMARY KEY, type INTEGER, amount REAL, currency TEXT, desc TEXT, "
				+ "status INTEGER, time INTEGER)");
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ trade_table
				+ "(_id INTEGER PRIMARY KEY, pair TEXT, type TEXT, amount REAL, rate REAL, "
				+ "order_id INTEGER,is_your_order NUMERIC, time INTEGER)");
		db.execSQL("CREATE TABLE IF NOT EXISTS "
				+ order_table
				+ "(_id INTEGER PRIMARY KEY, pair TEXT, type TEXT, amount REAL, rate REAL, "
				+ "status INTEGER, time INTEGER)");
